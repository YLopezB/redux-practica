...
export default function Cart() {
  ...
  return (
    <div className="mr-3 relative">
      <button
        onClick={
          productsCart.length != 0 ? () => dispatch(openModal(true)) : null
        }
        className="relative"
      >
        <div
          className={`absolute rounded-full w-5 h-5 bg-red-500 text-amber-50 flex items-center justify-center ${productsCart.length === 0 ? "hidden" : ""}`}
        >
